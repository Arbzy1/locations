...
| `npm run release` / `release:patch` / `release:minor` / `release:major` | Tag a semver release and promote `docs/changelog.md` |
| `npm run release:set -- v1.2.3` | Tag a specific version |
